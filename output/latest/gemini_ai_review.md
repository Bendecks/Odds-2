...
1.  **Current system status:** Proxy paper testing started, but not mature. Negative CLV trend from historical data. Automatic odds ingestion is working, but needs better coverage.
