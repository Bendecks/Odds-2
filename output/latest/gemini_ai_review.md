...
1.  Current system status: `paper_tracking_ready`
...
5.  One concrete change to prioritize next: Adjust calibration layer to reduce EV aggressiveness in the 0.00-0.35 probability band.
