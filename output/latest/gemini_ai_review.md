...
5.  One concrete change to prioritize next: Implement a more nuanced calibration strategy for the 0.00-0.35 probability band, potentially using multiple sub-bands with varying shrinkage.
