...
1.  **Current system status:** Proxy paper-testing started, but not mature. Negative CLV trend. Automatic proxy odds ingestion is working, but needs improvement.
...
5.  **Concrete change to prioritize next:** Refine calibration rules to reduce the negative CLV in the 0.00-0.35 probability band.
