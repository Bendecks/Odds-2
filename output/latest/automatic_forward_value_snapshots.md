...
- 2026-05-11 | Tondela vs Moreirense | sel=AWAY | src=football_data_max_market_proxy | odds=4.1 | prob=0.3488 | EV=0.43008 | match=1.0
- 2026-05-11 | Estrela vs Famalicao | sel=HOME | src=football_data_max_market_proxy | odds=3.7 | prob=0.3772 | EV=0.39564 | match=1.0
- 2026-05-11 | Huesca vs Sociedad B | sel=AWAY | src=football_data_max_market_proxy | odds=4.0 | prob=0.3488 | EV=0.3952 | match=1.0
- 2026-05-11 | Huesca vs Sociedad B | sel=AWAY | src=football_data_bet365_proxy | odds=3.8 | prob=0.3488 | EV=0.32544 | match=1.0
- 2026-05-11 | Estrela vs Famalicao | sel=HOME | src=football_data_average_market_proxy | odds=3.51 | prob=0.3772 | EV=0.323972 | match=1.0
- 2026-05-11 | Estrela vs Famalicao | sel=HOME | src=football_data_bet365_proxy | odds=3.5 | prob=0.3772 | EV=0.3202 | match=1.0
- 2026-05-11 | Benfica vs Sp Braga | sel=DRAW | src=football_data_max_market_proxy | odds=4.8 | prob=0.274 | EV=0.3152 | match=1.0
- 2026-05-11 | Huesca vs Sociedad B | sel=AWAY | src=football_data_average_market_proxy | odds=3.75 | prob=0.3488 | EV=0.308 | match=1.0
- 2026-05-11 | Tondela vs Moreirense | sel=AWAY | src=football_data_average_market_proxy | odds=3.75 | prob=0.3488 | EV=0.308 | match=1.0
- 2026-05-11 | Santa Clara vs Nacional | sel=AWAY | src=football_data_max_market_proxy | odds=3.75 | prob=0.3488 | EV=0.308 | match=1.0
