...
- Espanol vs Ath Bilbao | coverage=full_team_strength_match | selection=DRAW | odds=3.3 | prob=0.2922 | EV=-0.0357 | edge=-0.0108 | penalty=0.0357 | band=0.25-0.35 | risk=proxy_price_source | rule=none | tier=negative_ev_control_observation
- St Andrew Lions vs Ellerton FC | coverage=baseline_unmatched_fixture | selection=HOME | odds=4.75 | prob=0.3772 | EV=0.7917 | edge=0.1667 | penalty=0.7917 | band=0.35-0.45 | risk=baseline_coverage_only | rule=baseline_coverage_observe_only | tier=baseline_coverage_observation
