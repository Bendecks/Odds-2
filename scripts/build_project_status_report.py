...
report_files = {
    ...
    'forward_price_coverage': output_dir / 'forward_price_coverage_report.md',
    'automatic_forward_value_snapshots': output_dir / 'automatic_forward_value_snapshots.md',
    'proxy_candidate_observations': output_dir / 'proxy_candidate_observations.md',
    'proxy_candidate_explanations': output_dir / 'proxy_candidate_explanation_report.md',
...
status = {
    ...
    'includes_forward_price_coverage': (output_dir / 'forward_price_coverage_report.md').exists(),
    'includes_automatic_forward_value_snapshots': (output_dir / 'automatic_forward_value_snapshots.md').exists(),
    'includes_proxy_candidate_observations': (output_dir / 'proxy_candidate_observations.md').exists(),
    'includes_proxy_candidate_explanations': (output_dir / 'proxy_candidate_explanation_report.md').exists(),
