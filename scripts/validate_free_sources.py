...
add_check('odds-api.io forward prices', 'output/latest/odds_api_io_forward_prices.csv', required_columns=['fixture_id', 'home_team', 'away_team', 'market_home_odds', 'market_draw_odds', 'market_away_odds', 'source_quality'], file_type='csv', allow_empty=True)
add_check('odds-api.io forward fixtures', 'output/latest/odds_api_io_forward_fixtures.csv', required_columns=['fixture_id', 'match_date', 'home_team', 'away_team', 'source'], file_type='csv', allow_empty=True)
add_check('odds-api.io forward price status', 'output/latest/odds_api_io_forward_price_status.csv', required_columns=['enabled', 'calls_used', 'max_calls', 'max_events', 'fixture_rows', 'price_rows', 'errors', 'source_quality'], file_type='csv', allow_empty=False)
add_check('API-Football forward prices', 'output/latest/api_football_forward_prices.csv', required_columns=['fixture_id', 'home_team', 'away_team', 'market_home_odds', 'market_draw_odds', 'market_away_odds', 'source_quality'], file_type='csv', allow_empty=True)
add_check('API-Football forward fixtures', 'output/latest/api_football_forward_fixtures.csv', required_columns=['fixture_id', 'match_date', 'home_team', 'away_team', 'source'], file_type='csv', allow_empty=True)
add_check('API-Football forward price status', 'output/latest/api_football_forward_price_status.csv', required_columns=['enabled', 'calls_used', 'max_calls', 'max_fixtures', 'fixture_rows', 'price_rows', 'errors', 'source_quality'], file_type='csv', allow_empty=False)
...
add_check('Forward price coverage report', 'output/latest/forward_price_coverage_report.csv', required_columns=['prediction_id', 'match_date', 'home_team', 'away_team', 'has_any_automatic_price', 'has_fresh_api_price', 'has_odds_api_io_price'], file_type='csv', allow_empty=True)
add_check('Forward price coverage summary', 'output/latest/forward_price_coverage_summary.csv', required_columns=['forward_prediction_rows', 'automatic_price_rows', 'matches_with_any_automatic_price', 'matches_with_fresh_api_price', 'matches_with_odds_api_io_price', 'fresh_api_match_coverage_rate', 'real_money_ready'], file_type='csv', allow_empty=False)
add_check('Forward price source summary', 'output/latest/forward_price_source_summary.csv', required_columns=['source_name', 'source_type', 'source_quality', 'price_rows'], file_type='csv', allow_empty=True)
add_check('Proxy candidate observations', 'output/latest/proxy_candidate_observations.parquet', required_columns=['snapshot_id', 'prediction_id', 'selection', 'market_odds', 'probability', 'ev', 'proxy_candidate_tier', 'proxy_candidate_score', 'real_money_ready'], allow_empty=True)
add_check('Proxy candidate observation summary', 'output/latest/proxy_candidate_observation_summary.csv', required_columns=['automatic_value_rows', 'proxy_candidate_observation_rows', 'proxy_candidate_like_rows', 'suppressed_proxy_watchlist_rows', 'real_money_ready'], file_type='csv', allow_empty=False)
add_check('Proxy candidate explanation report', 'output/latest/proxy_candidate_explanation_report.csv', required_columns=['match_date', 'home_team', 'away_team', 'selection', 'primary_blockers', 'improvement_needed', 'real_money_ready'], file_type='csv', allow_empty=True)
add_check('Proxy candidate explanation summary', 'output/latest/proxy_candidate_explanation_summary.csv', required_columns=['proxy_candidate_rows', 'explained_rows', 'distinct_blockers', 'top_blocker', 'real_money_ready'], file_type='csv', allow_empty=False)
add_check('Proxy candidate blocker summary', 'output/latest/proxy_candidate_blocker_summary.csv', required_columns=['blocker', 'rows'], file_type='csv', allow_empty=True)
add_check('Automatic forward value snapshot summary', 'output/latest/automatic_forward_value_snapshot_summary.csv', required_columns=['forward_prediction_rows', 'proxy_price_rows', 'value_snapshot_rows', 'positive_ev_rows', 'matched_prediction_rows', 'source_type', 'real_money_ready'], file_type='csv', allow_empty=False)
add_check('Automatic forward value match diagnostics', 'output/latest/automatic_forward_value_match_diagnostics.csv', required_columns=['prediction_id', 'home_team', 'away_team', 'candidate_rows', 'best_match_confidence', 'matched_rows'], file_type='csv', allow_empty=True)
add_check('Proxy observation quality report', 'output/latest/proxy_observation_quality_report.csv', required_columns=['value_snapshot_rows', 'paper_proxy_observation_rows', 'positive_ev_value_rows', 'suppressed_band_observation_rows', 'real_money_ready'], file_type='csv', allow_empty=False)
add_check('Proxy observation by selection', 'output/latest/proxy_observation_by_selection.csv', required_columns=['selection', 'rows', 'avg_ev', 'max_ev'], file_type='csv', allow_empty=True)
