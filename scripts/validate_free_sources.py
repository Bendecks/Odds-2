...
add_check('Paper test log output', 'output/latest/paper_test_log_latest.csv', required_columns=['prediction_id', 'paper_test_tier', 'paper_test_score', 'paper_test_reason'], file_type='csv', allow_empty=True)
